...
class Email {
    ...
    public function enviarConfirmacion() {
         ...
         $mail->setFrom('gutierrezfigueroaLA@gmail.com');
         ...
         $contenido = '<html>';
         $contenido .= "<p><strong>Hola " . $this->nombre .  "</strong> Has Registrado Correctamente tu cuenta en AppSalon; pero es necesario confirmarla</p>";
